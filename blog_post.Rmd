...
As Business Data Analysts (BDAs) at zeroG, we try to create great visualizations and share them with our fellow BDAs during our monthly knowledge exchange meetings. For quite some time now, Jean-Philippe and I wanted to get our head around R visualizations. So we kicked off this side project we had two main goals in mind: to analyze adn provide some insights from our findings based on some Lufthansa reviews from Tripadvisor and to show you what kind of visualizations fit best depending on questions you are trying to answer in general.
